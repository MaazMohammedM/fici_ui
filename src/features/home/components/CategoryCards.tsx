...
const CategoryCards: React.FC = () => {
  ...
  return (
    <section className="bg-gradient-light dark:bg-gradient-dark py-16 px-16">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-3xl font-bold text-primary dark:text-secondary mb-8 text-center">
          Shop by Category
        </h2>
            ...
            >
              ...
              <div className="p-6">
                <div className="flex items-center justify-between">
                  <span className="text-lg font-semibold text-primary dark:text-secondary">
                    {category.name}
                  </span>
