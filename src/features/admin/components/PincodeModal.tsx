...
const pincodeSchema = z.object({
  ...
  free_shipping_threshold: z.number().min(0, 'Cannot be negative'),

  delivery_time: z.string().min(1, 'Delivery time is required'),

  exchange_window_days: z.number().min(0, 'Cannot be negative'),

  is_exchangeable: z.boolean(),

  is_returnable: z.boolean(),

  return_window_days: z.number().min(0, 'Cannot be negative'),
      ...
      try {
        ...
        if (data) {
          ...
          reset({
            ...
            // Convert pincode to string for form
            ...
            exchange_window_days: data.exchange_window_days || 3,

            is_exchangeable: data.is_exchangeable ?? true,
        ...
        <form onSubmit={handleSubmit(processSubmit)} className="space-y-6">
          ...
          {activeTab === 'financials' && (
            ...
            <div className="space-y-6 pt-4">
              ...
              {/* Exchange and Return Settings */}

              <div className="space-y-4">

                <h4 className="text-sm font-medium text-gray-900 dark:text-gray-100 border-b pb-2">Exchange & Return Settings</h4>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      placeholder="Number of days for exchange"

                      {...register('exchange_window_days', { valueAsNumber: true })}

                    />

                    {errors.exchange_window_days && (

                      <p className="text-sm text-red-500 dark:text-red-400">{errors.exchange_window_days.message}</p>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      placeholder="Number of days for return"
                    ...
                    {errors.return_window_days && (
                      ...
                      <p className="text-sm text-red-500 dark:text-red-400">{errors.return_window_days.message}</p>
                  ...
                  <div className="flex items-center justify-between rounded-lg border dark:border-gray-600 p-3 sm:p-4">
                    ...
                    <div className="flex-1">
                      ...
                      <h4 className="font-medium text-sm sm:text-base">Exchange Allowed</h4>

                      <p className="text-xs sm:text-sm text-muted-foreground">

                        {watch('is_exchangeable') ? 'Items can be exchanged' : 'Items cannot be exchanged'}
                    ...
                    <Switch
                      ...
                      checked={watch('is_exchangeable')}

                      onCheckedChange={(checked) => setValue('is_exchangeable', checked)}
                  ...
                  <div className="flex items-center justify-between rounded-lg border dark:border-gray-600 p-3 sm:p-4">
                    ...
                    <div className="flex-1">
                      ...
                      <h4 className="font-medium text-sm sm:text-base">Return Allowed</h4>

                      <p className="text-xs sm:text-sm text-muted-foreground">

                        {watch('is_returnable') ? 'Items can be returned' : 'Items cannot be returned'}
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) => setValue('is_returnable', checked)}
