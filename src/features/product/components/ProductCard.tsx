    ...
    return (
      <div className="flex gap-4 p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:shadow-md transition-shadow">
        ...
        <div className="flex-1 space-y-2">
          ...
          <div className="flex gap-2">
            <button className="flex-1 bg-primary hover:bg-primary-active text-white px-4 py-2 rounded text-sm transition-colors">
              Add to Cart
            </button>
  ...
  return (
    <div className="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
      ...
      <div className="p-4 space-y-2">
        ...
        <button className="w-full bg-primary hover:bg-primary-active text-white py-2 rounded text-sm transition-colors">
          Add to Cart
        </button>
      </div>
    </div>
